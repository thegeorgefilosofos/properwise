        ...
        {canInvest && (
          <Section icon={<Percent size={15} />} title="Εργαλεία απόδοσης" sub="Ανατοκισμός επανεπένδυσης και μόχλευση ιδίων κεφαλαίων">
            ...
            {/* ══ ΣΤΗΝ ΤΑΜΠΛΕΤΑ ΟΙ ΔΥΟ ΚΑΡΤΕΣ ΕΠΑΙΡΝΑΝ ΛΙΓΟΤΕΡΟ ΠΛΑΤΟΣ ΑΠΟ ΤΟ ΤΗΛΕΦΩΝΟ
                ...
                το flex της `.field-row` βγαίνει χωρίς media query: κάτω από 744
                διαθέσιμα εικονοστοιχεία οι κάρτες στοιβάζονται. Μετρημένο ξανά:
            ...
            <div className="field-row" style={{ '--fr-min': 'min(100%, 364px)', '--fr-gap': '16px', alignItems: 'stretch' } as React.CSSProperties}>
              {/* Ανατοκισμός */}
