...
export default function TabRentROI({ propertyId, userId, propertyValue, profileType = 'individual', legalForm = 'individual', plan = 'free' }: Props) {
  ...
  // Είσπραξη μέσω τραπέζης: προϋπόθεση της τεκμαρτής έκπτωσης 5% από 1.7.2027
  ...
  const printReport = () => {
    ...
    const asmpItems = [
      ...
      `Είσπραξη ενοικίων μέσω τραπέζης: ${rentsBank ? 'ναι' : 'όχι (η τεκμαρτή έκπτωση 5% ισχύει· η προϋπόθεση τραπεζικής είσπραξης αρχίζει 1.7.2027, ν.5222/2025)'}`,
