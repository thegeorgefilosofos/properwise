...
// ΤΟ ΚΛΕΙΔΙ ΜΕΝΕΙ, Η ΕΤΙΚΕΤΑ ΓΡΑΦΕΤΑΙ ΣΑΝ ΕΛΛΗΝΙΚΑ. Οι κατηγορίες και οι χώροι
// αποθηκεύονται με τη μορφή που έχουν από την αρχή («Ηλεκτρικές Συσκευές»,
// «Θέρμανση & Ψύξη», «Κύριο Υπνοδωμάτιο») και σε αυτή κλειδώνουν οι διάρκειες
// ζωής, τα φίλτρα και τα αντικείμενα που υπάρχουν ήδη στη βάση. Η οθόνη όμως τα
// τύπωνε αυτούσια, με κεφαλαίο σε κάθε λέξη και «&». Η αντιστοίχιση ζει εδώ,
// δίπλα στους καταλόγους· ό,τι δεν είναι μέσα (π.χ. χώρος που έγραψε ο χρήστης)
// εμφανίζεται όπως γράφτηκε.
const INVENTORY_DISPLAY: Record<string, string> = {
  'Ηλεκτρικές Συσκευές': 'Ηλεκτρικές συσκευές',
  'Θέρμανση & Ψύξη': 'Θέρμανση και ψύξη',
  'Κύριο Υπνοδωμάτιο': 'Κύριο υπνοδωμάτιο',
  'Παιδικό Δωμάτιο': 'Παιδικό δωμάτιο',
  'Αίθουσα Συσκέψεων': 'Αίθουσα συσκέψεων',
  'Χώρος Εργασίας': 'Χώρος εργασίας',
  'Κοινόχρηστος Χώρος': 'Κοινόχρηστος χώρος',
}
/** Η ετικέτα μιας αποθηκευμένης κατηγορίας ή ενός χώρου. */
export const inventoryLabel = (v?: string | null): string => (v ? INVENTORY_DISPLAY[v] ?? v : '')
