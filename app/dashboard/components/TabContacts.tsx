        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, marginBottom: 10 }}>
          {contact.phone && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <a href={'tel:' + contact.phone} style={{ fontSize: 'var(--fs-base)', color: 'var(--text-secondary)', fontFamily: T.font.sans, fontVariantNumeric: 'tabular-nums', textDecoration: 'none' }}>{displayPhone(contact.phone)}</a>
