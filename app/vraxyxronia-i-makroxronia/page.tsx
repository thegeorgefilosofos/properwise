...
const FAQ: { q: string; a: string }[] = [
  {
    ...
    a: 'Είναι το ποσοστό των διανυκτερεύσεων του χρόνου από το οποίο και πάνω η βραχυχρόνια αφήνει '
     + 'περισσότερα από τη μακροχρόνια. Είναι το στοιχείο που πραγματικά σε βοηθάει στη λήψη '
     + 'απόφασης, γιατί δεν εξαρτάται από το πόσο αισιόδοξος ήσουν κατά την πρόβλεψη της '
     + 'πληρότητας: το συγκρίνεις με ό,τι δεδομένα υπάρχουν για την περιοχή του ακινήτου και '
     + 'απαντάς μόνος σου.',
  },
  {
