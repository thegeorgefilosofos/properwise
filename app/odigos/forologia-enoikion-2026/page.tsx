...
const TIMELINE: { step: string; what: string; source: string }[] = [
  ...
  { step: 'Δεύτερη μετάθεση', what: 'Έναρξη 1.10.2026', source: 'ν.5294/2026, άρθρο 48 · ΦΕΚ Α΄ 58/08.04.2026' },
