  ...
  return (
    <div className="po-tool-page" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)', minHeight: '100vh', fontFamily: T.font.sans }}>
      ...
      <main style={{ ...WRAP, padding: `clamp(28px,4vw,44px) ${WRAP_PAD} clamp(56px,7vw,88px)` }}>
        ...
        {/* Εισαγωγή */}
        <p className="lg-p">
          {hy('Η βραχυχρόνια μίσθωση (Airbnb, Booking) δεν φορολογείται σαν την κλασική ενοικίαση σε όλα. Το εισόδημα, όταν δεν παρέχονται υπηρεσίες, μπαίνει στην ίδια κλίμακα με τα ενοίκια· πάνω από αυτό όμως προστίθενται δύο τέλη που δεν υπάρχουν στη μακροχρόνια: το Τέλος Ανθεκτικότητας στην Κλιματική Κρίση και, για ορισμένους, το τέλος παρεπιδημούντων.')}
        </p>
        <p className="lg-p">
          {hy('Ο οδηγός εξηγεί, με πηγές, τι πληρώνεις και ποιος το πληρώνει, ώστε να ξέρεις την τάξη μεγέθους πριν μιλήσεις με τον λογιστή σου.')}
        </p>
        ...
        <div className="lg-note" style={{ marginTop: 'clamp(40px,5vw,60px)' }}>
          {hy('Ο παρών οδηγός και κάθε συνδεδεμένος υπολογισμός είναι ενδεικτικοί. Τα ακριβή ποσά του ΤΑΚΚ, οι μήνες της περιόδου και οι εξαιρέσεις ορίζονται από την ΑΑΔΕ και τους δήμους. Δεν αποτελούν επίσημο εκκαθαριστικό ούτε υποκαθιστούν λογιστή ή φοροτεχνικό.')}
        </div>
      </main>
