...
const PILLARS = [
  { label: 'Από τη φωτογραφία στη σωστή θέση', text: 'Φωτογράφισε λογαριασμό, μισθωτήριο ή ασφαλιστήριο. Το διαβάζει και το καταχωρεί στη σωστή θέση.' },
  { label: 'Βοηθός με φωνή που ξέρει το ακίνητό σου', text: 'Ρώτα στα ελληνικά, με κείμενο ή με τη φωνή σου. Απαντά από τα δεδομένα του δικού σου ακινήτου.' },
