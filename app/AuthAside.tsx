  ...
  return (
    <div className="auth-aside" style={{ width: '45%', minWidth: 400, background: 'linear-gradient(180deg, #070b12 0%, #0a0f18 70%, #0b101a 100%)', borderRight: '1px solid rgba(255,255,255,.07)', display: 'flex', flexDirection: 'column', padding: '48px 48px', overflow: 'hidden', position: 'relative', fontFamily: T.font.sans }}>
      ...
      <div style={{ position: 'relative', marginBottom: 40 }}>
        ...
        {/* ΤΟ `balance` ΓΙΑΤΙ Η ΓΡΑΜΜΗ ΑΦΗΝΕ ΟΡΦΑΝΗ ΛΕΞΗ. Το πάνελ είναι 45%
            της οθόνης μείον 96 γεμίσματος: στα 1024 μένουν 365 καθαρά, ενώ η
            επικεφαλίδα στα 30,7 θέλει περίπου 380. Επεφτε δηλαδή σε δεύτερη
            γραμμή με ΜΙΑ λέξη μόνη της («σου»), ακριβώς πάνω από την μπλε
            σειρά — τρεις γραμμές, η μεσαία με τρία γράμματα. Το `balance`
            μοιράζει το κείμενο σε ίσες γραμμές· ο αριθμός των γραμμών δεν
            αλλάζει, αλλάζει το πού σπάνε. Ιδιο ιδίωμα με τις επικεφαλίδες των
            νομικών σελίδων και της αρχικής. */}
        <div style={{ fontSize: 'clamp(27px, 3vw, 38px)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.12, margin: '0 0 18px', color: '#fff', textWrap: 'balance' }}>
