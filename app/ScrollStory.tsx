...
// Η ΠΡΩΤΗ ΠΡΑΞΗ ΔΕΙΧΝΕΙ ΜΙΣΘΩΤΗΡΙΟ, ΟΧΙ ΤΟΝ ΛΟΓΑΡΙΑΣΜΟ ΤΟΥ HERO. Ο ίδιος
// λογαριασμός των 88,50€ εμφανιζόταν δύο φορές σε λιγότερο από μία οθόνη· με
// άλλο έγγραφο, η ενότητα δείχνει ότι η σάρωση διαβάζει και κάτι άλλο.
const PanelLease = () => <PanelScan doc="lease" />
...
export default function ScrollStory() {
  ...
  // ΜΕΤΡΗΜΕΝΟ ΣΕ CHROMIUM, ΣΕ ΤΕΣΣΕΡΑ ΠΛΑΤΗ ΕΠΙ ΤΡΙΑ ΥΨΗ. Το πλαίσιο έδινε
  // 348,8 εικονοστοιχεία καθαρά σε οθόνη 1440×790 και το πάνελ «Πίνακας»
  // ζητούσε 395: το κουτί της πρότασης έβγαινε 23 ΚΑΤΩ από την κάτω ακμή και
  // το «overflow: hidden» το έκοβε. Στα 1280×800 ίδια ιστορία (−20,5) και στα
  // 1512×860 οριακά (−4,9). Δηλαδή σε κάθε φορητό, στην πρώτη εικόνα του
  // προϊόντος.
  //
  // ΔΥΟ ΑΛΛΑΓΕΣ, ΟΧΙ ΜΙΑ. Το πλαίσιο ανεβαίνει (430 δάπεδο αντί 400, 59vh αντί
  // 52vh, 530 ταβάνι αντί 500) ΚΑΙ το πάνελ αδυνατίζει κατά 46 σε γεμίσματα
  // και ύψος μπαρών. Μόνο του το ψηλότερο πλαίσιο δεν έφτανε: το ταβάνι θα
  // έπρεπε να πάει στα 515 για να χωρέσει το παλιό πάνελ με μηδέν αέρα,
  // δηλαδή θα ξανακολλούσε στις ακμές.
  //
  // ΤΟ ΔΑΠΕΔΟ ΕΙΝΑΙ ΜΕΤΡΗΜΕΝΟ, ΟΧΙ ΔΙΑΛΕΓΜΕΝΟ: στα 430 το καρφωμένο πλαίσιο
  ...
  // βάρους εκτός ορίου κατά εβδομήντα πέντε. Ο μεταγλωττιστής πετά τα σχόλια
  // της JavaScript· ό,τι είναι μέσα σε ανάστροφα εισαγωγικά δεν το αγγίζει.
  return (
