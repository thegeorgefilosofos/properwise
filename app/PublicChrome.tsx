    ...
    <footer style={{ borderTop: '1px solid var(--border-subtle)' }}>
      <div style={{ ...WRAP, padding: `clamp(36px,5vw,56px) ${WRAP_PAD} clamp(24px,3vw,32px)` }}>
        <div className="lp-foot">
          ...
          {/* Ο ΣΥΝΔΕΣΜΟΣ «ΟΔΗΓΟΙ» ΕΙΝΑΙ Η ΚΑΘΟΛΙΚΗ ΠΟΡΤΑ. Οι οδηγοί φαίνονταν
              μόνο μέσα από το κάθε εργαλείο ή από αναζήτηση· εδώ αποκτούν
              μόνιμη θέση στο υποσέλιδο, σε κάθε δημόσια σελίδα, προς τον κόμβο
              /odigos. Μπαίνει τελευταίος στη στήλη των δωρεάν εργαλείων γιατί
              μαζί τους απαντά στο «τι είναι δωρεάν και τι μαθαίνω». */}
          <FootCol label="Εργαλεία" links={[['/ypologismos-enfia', 'ΕΝΦΙΑ'], ['/ypologismos-forou-enoikion', 'Φορολογία ενοικίων'], ['/kathari-apodosi', 'Καθαρή απόδοση'], ['/vraxyxronia-i-makroxronia', 'Βραχυχρόνια ή μακροχρόνια'], ['/odigos', 'Οδηγοί']]} />
...
const TOOL_SOURCES = {
  ...
  yield: 'Φόρος εισοδήματος ενοικίων 2026 (ν.5246/2025) · ΕΝΦΙΑ (ΑΑΔΕ) · πραγματικές δαπάνες',
} as const;
