    ...
    <footer style={{ borderTop: '1px solid var(--border-subtle)' }}>
      <div style={{ ...WRAP, padding: `clamp(36px,5vw,56px) ${WRAP_PAD} clamp(24px,3vw,32px)` }}>
        <div className="lp-foot">
          ...
          {/* Δωρεάν εργαλεία: υπολογιστές που απαντούν «πόσο» πριν την εγγραφή. */}
          ...
          <FootCol label="Οδηγοί" links={[['/odigos/forologia-enoikion-2026', 'Φορολογία ενοικίων 2026'], ['/odigos/airbnb-takk-2026', 'Airbnb και ΤΑΚΚ 2026'], ['/odigos/pos-ypologizetai-o-enfia', 'Πώς υπολογίζεται ο ΕΝΦΙΑ'], ['/odigos/kathari-apodosi-akinitou', 'Καθαρή απόδοση ακινήτου']]} />
