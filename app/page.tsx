...
const FAQ = [
  ...
  { q: 'Είναι ασφαλή τα δεδομένα μου;', a: 'Η σύνδεση είναι πάντα κρυπτογραφημένη και κάθε λογαριασμός απομονώνεται σε επίπεδο βάσης: βλέπεις τα δικά σου δεδομένα και μόνο όσα εσύ μοιράζεσαι. Κατεβάζεις ή διαγράφεις τα δεδομένα σου όποτε θέλεις από τον «Λογαριασμό». Η βάση και τα αρχεία βρίσκονται στη Φρανκφούρτη.' },
...
const SECURITY = [
  ...
  { t: 'Εξαγωγή και διαγραφή', d: 'Κατεβάζεις όλα σου τα δεδομένα σε αρχείο ή σβήνεις τον λογαριασμό, όποτε θέλεις.', i: 'M12 3v12M7 10l5 5 5-5M5 21h14' },
    ...
    <div className="lp-root min-h-dvh" style={{ color: TEXT, fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <style>{`
        ...
        /* Δύο στήλες ΚΑΙ δύο σειρές, με ροή κατά στήλη: αριστερά η σύνδεση και
           η απομόνωση, δεξιά η εξαγωγή και η βάση. Οι δύο σειρές του
