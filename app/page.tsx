...
// ΤΟ ΣΗΜΑ ΣΤΟΝ ΤΙΤΛΟ: Η ΑΝΑΖΗΤΗΣΗ ΝΙΚΑΕΙ ΤΟ ΠΑΡΑΘΥΡΟ.
// Ο τίτλος της αρχικής είναι η πιο ισχυρή δήλωση μάρκας στη Google — τον βλέπει
// ΚΑΘΕ αναζητητής. Γι' αυτό μπαίνει το σήμα, ως κατάληξη μέσω του προτύπου της
// ρίζας (`%s · PROPERWISE`): keyword μπροστά, σήμα μία φορά.
//
// Το κόστος είναι μικρό και συνειδητό: στο παράθυρο της εγκατεστημένης
// εφαρμογής (manifest name + τίτλος) το σήμα εμφανίζεται δύο φορές — αλλά αυτό
// το βλέπουν μόνο όσοι έχουν εγκαταστήσει το PWA, ελάχιστοι έναντι όλων όσων
...
const FEATURES = [
  // ΟΙ ΛΕΞΕΙΣ ΤΩΝ ΚΑΡΤΩΝ. Το εικονίδιο των αποδόσεων ήταν «$» σε προϊόν που
  // μετρά σε ευρώ· είναι πλέον «€». Και η Νόα λέγεται με το όνομά της, όπως σε
  // κάθε άλλη οθόνη, όχι «Βοηθός».
  //
  ...
  { t: `${ASSISTANT_NAME}, στα ελληνικά`, d: 'Συγκρίνει και προτείνει με βάση τα δικά σου ενοίκια και δαπάνες, όχι γενικές συμβουλές.', i: 'M21 12a8 8 0 0 1-8 8H8l-5 3 1.4-4.2A8 8 0 1 1 21 12M8.5 12h.01M12 12h.01M15.5 12h.01' },
  ...
  { t: 'Αποδόσεις και σενάρια μίσθωσης', d: 'Καθαρή απόδοση μετά τον φόρο και η βραχυχρόνια δίπλα στη μακροχρόνια.', i: 'M18 7a6 6 0 1 0 0 10M4 10h9M4 14h9' },
  { t: 'Φορολογία 2026', d: 'Υποχρεώσεις, προθεσμίες και η κλίμακα που ισχύει για τα εισοδήματα κάθε έτους.', i: 'M9 7h6M9 11h6M9 15h4M5 3h14v18l-3-2-2 2-2-2-2 2-3-2z' },
...
const FAQ = [
  ...
  // ΤΟ ΙΔΙΟ ΚΑΙ ΓΙΑ ΤΟ ΠΟΥ ΠΑΝΕ ΤΑ ΚΕΡΔΗ: υπόσχεση που δεν ελέγχεται από τον
  ...
  // ΤΟ ΔΙΑΣΤΗΜΑ ΔΙΑΤΗΡΗΣΗΣ ΕΡΧΕΤΑΙ ΑΠΟ ΤΟ billingWords, ΟΠΩΣ ΚΑΙ Η ΑΠΟ ΠΑΝΩ.
  // Γραμμένο εδώ με το χέρι, υποσχόταν διαγραφή σε τριάντα ημέρες ενώ ο
  // καθαρισμός δεν τρέχει όσο η χρέωση είναι κλειστή: δύο γειτονικές απαντήσεις
  // με αντίθετο διάστημα· και οι δύο μέσα στο FAQPage (άρθρο 13§2 α΄ GDPR).
  { q: 'Τι γίνεται με τα δεδομένα μου αν σταματήσω;', a: billingWords().lapsedRetentionShort },
  // Χωρίς την υπόσχεση για εφαρμογή iOS και Android: δεν έχει ημερομηνία και
  // ταξίδευε ως γεγονός στα δομημένα δεδομένα της σελίδας.
  { q: 'Δουλεύει στο κινητό;', a: 'Ναι. Προσαρμόζεται σε κινητό, tablet και υπολογιστή και η σάρωση αποδίδει καλύτερα με την κάμερα του κινητού ή του tablet. Εγκαθίσταται και στην αρχική οθόνη σαν εφαρμογή.' },
...
const STATS = [
  ...
  { n: '11', u: 'πάροχοι ρεύματος',        l: 'Τα τιμολόγιά τους, με τον μήνα του τελευταίου ελέγχου.' },
...
const AUDIENCE = [
  ...
  {
    // Η ομάδα ανοίγει ήδη στον «Επαγγελματία» (TEAM_LINE)· αυτό που
    // ξεχωρίζει εδώ είναι το χωρίς όριο χαρτοφυλάκιο και η άμεση επικοινωνία.
    id: 'office' as const,
    tag: PLANS.office.name,
    t: 'Μεγάλο χαρτοφυλάκιο',
    d: 'Απεριόριστα ακίνητα, άμεση επικοινωνία μαζί μας.',
  },
];
...
// εύρος, διαβάζεται ως γέμισμα. Και ζευγαρωμένα ανά δύο έμεναν δύο κελιά με
// το ίδιο κείμενο· τώρα είναι ένα και ο φάκελος του λογιστή παίρνει τη θέση.
//
// ΤΟ ΠΑΚΕΤΟ ΛΕΓΕΤΑΙ ΔΙΠΛΑ ΣΤΗ ΔΥΝΑΤΟΤΗΤΑ ΠΟΥ ΤΟ ΘΕΛΕΙ. Το ημερολόγιο εγγραφών
// και οι κινήσεις τράπεζας ανοίγουν από τον «Επαγγελματία» (FEATURE_MIN_PLAN)·
// χωρίς ένδειξη, ο αγοραστής του φθηνότερου πακέτου τα διάβαζε ως δικά του.
const fromPlan = (min: keyof typeof FEATURE_MIN_PLAN) => `, από «${PLANS[FEATURE_MIN_PLAN[min]].name}»`;
const WORKS_WITH = [
  ...
  { t: 'SoftOne, Epsilon, QuickBooks, Xero', d: `ημερολόγιο λογιστικών εγγραφών για εισαγωγή${fromPlan('accounting_journal')}` },
  { t: 'Φάκελος λογιστή', d: 'ενημερωμένο αρχείο με όσα ζητά ο λογιστής και τις ελλείψεις' },
  { t: 'Airbnb, Booking.com', d: 'συγχρονισμός κρατήσεων μέσω iCal, χωρίς διπλές εγγραφές' },
  { t: 'Κινήσεις τράπεζας', d: `εισαγωγή CSV και αντιστοίχιση με τα ενοίκια${fromPlan('bank_import')}` },
...
const SECURITY = [
  ...
  { t: 'Κρυπτογραφημένη σύνδεση', d: 'Η σύνδεσή σου με την εφαρμογή γίνεται πάντα μέσω TLS, σε κάθε συσκευή και δίκτυο.', i: 'M5 11h14v10H5zM8 11V7a4 4 0 0 1 8 0v4' },
  ...
  { t: 'Καμία εκπαίδευση μοντέλων', d: 'Ο πάροχος AI δεσμεύεται με σύμβαση να μην εκπαιδεύει μοντέλα με τα δεδομένα σου.', i: 'M12 2v4M12 18v4M2 12h4M18 12h4M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z' },
  // «ΜΕΝΟΥΝ» ΣΗΜΑΙΝΕ ΟΤΙ ΤΙΠΟΤΑ ΔΕΝ ΦΕΥΓΕΙ ΑΠΟ ΤΗΝ ΕΕ. Φεύγουν το αντίγραφο
  // ασφαλείας, ό,τι στέλνεται στον βοηθό και τα email· τα λέει η σελίδα
  // «Ποιοι είμαστε». Εδώ λέγεται μόνο πού φιλοξενείται το σύστημα καταγραφής.
  { t: 'Βάση δεδομένων στην ΕΕ', d: 'Η βάση, η ταυτοποίηση και τα αρχεία σου φιλοξενούνται στη Φρανκφούρτη.', i: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20M2 12h20M12 2c3 3 3 17 0 20M12 2c-3 3-3 17 0 20' },
];
...
const REFERRAL = [
  ...
  },
  {
    ...
    // Ο στόχος μετρά συνδρομητές· όσο δεν υπάρχει ταμείο, η κάρτα το λέει
    // (billingWords), αντί να υπόσχεται κάτι που δεν πιάνεται.
    note: billingWords().partnerTarget,
    ...
    d: 'Πιάνεις τον στόχο και ο επόμενος μήνας δεν χρεώνεται.',
  ...
  return (
    <div className="lp-root min-h-dvh" style={{ color: TEXT, fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      {/* ΤΑ ΣΧΟΛΙΑ ΤΟΥ ΦΥΛΛΟΥ ΕΙΝΑΙ ΣΧΟΛΙΑ JAVASCRIPT, ΓΡΑΜΜΕΝΑ ΩΣ «${… ''}».
          ...
          φορτίο της React: 49 KB ελληνικής πρόζας από τα 63,5 του φύλλου. Ο
      ...
      <style>{`
        ...
        .lp-root {
          ...
          --surface-raised: var(--mkt-bg-surface);
        ...
        ${/* ΚΑΙ ΤΕΛΙΚΑ ΣΕ ΔΙΚΗ ΤΗΣ ΓΡΑΜΜΗ, ΣΕ ΚΑΘΕ ΠΛΑΤΟΣ. Με το «start» το κενό της
           μακρύτερης λέξης έπεφτε στο τέλος της γραμμής, αλλά η γραμμή κεντραρόταν
           μαζί του: στα 1440 η πρώτη σειρά του τίτλου καθόταν 40 εικονοστοιχεία
        ...
        ${/* ΕΝΑΣ ΓΥΡΟΣ ΚΑΙ ΣΤΑΣΗ ΣΤΗΝ ΠΡΩΤΗ ΛΕΞΗ. Η εναλλαγή έτρεχε για πάντα, χωρίς
           ...
           2.2.2. Κάθε λέξη φαίνεται μία φορά και ο τίτλος μένει στο «τον
        ...
        @keyframes lpRotorRest {
          from { opacity: 0; transform: translateY(.34em) scale(.97); filter: blur(6px); }
        ...
        .lp-aud { grid-template-rows: auto auto 1fr auto; }
        ...
        ${/* ΤΟ ΜΕΤΡΟ ΑΝΑΓΝΩΣΗΣ ΙΣΧΥΕΙ ΚΑΙ ΕΔΩ. Μετρημένο στα 1.440 με το
           scripts/measure-prose.mjs: 102 χαρακτήρες ανά γραμμή στα 16
           εικονοστοιχεία. Είναι η πρώτη παράγραφος που διαβάζει όποιος δεν μας
           ξέρει· δεν επιτρέπεται να είναι η πιο κουραστική της σελίδας. Τα 62ch
           είναι το ίδιο μέτρο με την .po-prose, που κρατά τις νομικές σελίδες
           και τα πλακίδια του ταμπλό — γραμμένο εδώ ως ιδιότητα αντί για κλάση,
           επειδή ο κανόνας ζει μέσα στο ίδιο το φύλλο της σελίδας.

           ΧΩΡΙΣ ΑΝΑΣΤΡΟΦΑ ΕΙΣΑΓΩΓΙΚΑ ΣΕ ΑΥΤΟ ΤΟ ΣΧΟΛΙΟ: ολόκληρο το φύλλο ζει
           μέσα σε template literal της JavaScript και το πρώτο τους θα το
           έκλεινε στη μέση. */''}
        .lp-why p {
        ...
        ${/* ΜΙΑ ΣΤΗΛΗ ΣΤΟ ΤΗΛΕΦΩΝΟ. Δύο στήλες των 175 έσπαγαν το «SoftOne, Epsilon,
           QuickBooks, Xero» σε δύο σειρές και τη λεζάντα του σε πέντε. Η γραμμή
           ανάμεσα στα κελιά είναι ήδη το φόντο του πλέγματος, οπότε μένει. */''}
        @media (max-width: 520px) {
          .lp-works { grid-template-columns: 1fr !important; }
        }

        ${/* ΟΙ ΔΥΟ ΚΑΡΤΕΣ ΤΗΣ ΣΥΣΤΑΣΗΣ ΔΕΝ ΕΙΝΑΙ ΚΑΡΟΥΖΕΛ. Ως καρουζέλ στα 820 δεν
           γέμιζαν το πλάτος (τελείωναν ογδόντα εικονοστοιχεία πριν το δοχείο) και,
           χωρίς το subgrid του πλέγματος, ο ένας τίτλος καθόταν δώδεκα πιο χαμηλά
           από τον άλλο. Μένουν πλέγμα δύο στηλών ως τα 700 και από κει μία στήλη:
           δύο κάρτες στοιβάζονται χωρίς κόστος. */''}
        ...
        @media (max-width: 860px) {
          ...
          .lp-plans::-webkit-scrollbar,
          .lp-aud::-webkit-scrollbar { display: none; }
          .lp-aud { display: flex !important; }
          .lp-aud > * { flex: 0 0 min(84vw, 320px); scroll-snap-align: center; }
      ...
      <header className="lp-head" style={{ position: 'sticky', top: 0, zIndex: 50, background: 'color-mix(in srgb, var(--bg-base) 78%, transparent)', borderBottom: `1px solid ${LINE}` }}>
        ...
        <nav style={{ ...wrap, height: 64, display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          {/* Οι ίδιοι σύνδεσμοι με κάθε άλλη δημόσια σελίδα (PublicNav): «Τιμές»,
              ...
              «Είσοδος», δεν σβήνει· ο επιστρέφων χρήστης δεν έχει άλλο δρόμο. */}
          <PublicNav signedIn={loggedIn && (
            <Link href="/dashboard" className="lp-cta lp-primary" style={{ textDecoration: 'none', fontSize: 14, fontWeight: 700, padding: '9px 18px', borderRadius: T.radius.pill, whiteSpace: 'nowrap' }}>Ο πίνακάς σου</Link>
          )} />
        </nav>
      </header>
      ...
      <section className="lp-hero" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ ...wrap, position: 'relative', zIndex: 1, paddingTop: 'clamp(40px, 5.5vw, 68px)', paddingBottom: GAP, textAlign: 'center' }}>
          ...
          {/* ΤΡΙΑ ΣΤΟΙΧΕΙΑ ΠΟΥ ΔΕΝ ΣΠΑΝΕ ΣΤΗ ΜΕΣΗ. Στα 390 η γραμμή έπεφτε «…· Χωρίς
              / δέσμευση · …» και το «Σταματάς όποτε θέλεις» ξανάλεγε το «Χωρίς
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        ...
        <div className="lp-sec" style={{ background: PANEL, border: `1px solid ${LINE}`, borderRadius: T.radius.card, padding: 'clamp(24px, 3vw, 38px)' }}>
          ...
          {/* Η ΑΠΟΚΑΛΥΨΗ ΓΙΑ ΤΟΥΣ ΠΑΡΟΧΟΥΣ ΕΚΤΟΣ ΕΕ ΕΙΝΑΙ ΨΙΛΑ ΓΡΑΜΜΑΤΑ ΟΛΗΣ
              ...
              ΕΛΕΓΕ «ΟΙ ΣΥΜΒΑΣΕΙΣ ΚΛΕΙΝΟΥΝ ΠΡΙΝ ΤΗΝ ΚΥΚΛΟΦΟΡΙΑ» ενώ το μητρώο
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP_ACT }}>
        ...
        <div className="lp-why">
          {/* Η ΣΤΟΙΧΙΣΗ ΠΕΡΑ ΠΕΡΑ ΕΙΧΕ ΞΑΝΑΜΠΕΙ ΑΠΟ ΤΟ JSX, ενώ ο κανόνας του
              .lp-why εξηγεί γιατί έφυγε. Και η τρίτη παράγραφος υποσχόταν «τα
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        <SectionHead over="Σε ποιον απευθύνεται" title="Τέσσερα πακέτα, τέσσερις διαφορετικές ανάγκες" sub="Ίδια εφαρμογή σε όλα τα πακέτα. Αλλάζει πόσα ακίνητα χωράνε και τι χρειάζεται μια ομάδα." />
        {/* «ΑΥΤΟΣ ΕΙΜΑΙ ΕΓΩ» ΠΡΕΠΕΙ ΝΑ ΟΔΗΓΕΙ ΣΤΟ «ΑΡΑ ΑΥΤΟ ΠΑΙΡΝΩ». Οι κάρτες
            ονόμαζαν πακέτο και δεν πατιόνταν. Κάθε κάρτα οδηγεί πλέον στην εγγραφή
            με το πακέτο της ήδη επιλεγμένο, όπως τα κουμπιά του τιμοκαταλόγου. */}
        <div className="lp-aud">
          {AUDIENCE.map(a => (
            <Link key={a.id} href={`/signup?plan=${a.id}&cycle=monthly`} className="lp-card" style={{ background: PANEL, border: `1px solid ${LINE}`, borderRadius: T.radius.card, padding: 'clamp(22px, 2.6vw, 28px)', color: 'inherit', textDecoration: 'none' }}>
              ...
              <span style={{ marginTop: 14, fontSize: 14, fontWeight: 600, color: ACCENT }}>Ξεκίνα με αυτό το πακέτο</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section id="pricing" className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        ...
        <div className="lp-plans" style={{ display: 'grid', gridTemplateColumns: `repeat(${LANDING_PLANS.length}, minmax(0, 1fr))`, gap: 12, alignItems: 'stretch' }}>
          {LANDING_PLANS.map((id, i) => {
            ...
            const paidMonths = Math.round(plan.priceAnnual / plan.priceMonthly);
            return (
              <PlanCard
                key={id}
                name={plan.name}
                ...
                //
                // ΚΑΙ ΛΕΓΕΤΑΙ ΜΕ ΤΟ ΠΟΣΟ ΠΟΥ ΠΛΗΡΩΝΕΙΣ, ΟΧΙ ΩΣ «ΔΩΡΕΑΝ». Δωρεάν
                // στο PROPERWISE είναι μόνο η δοκιμή και οι μήνες από συστάσεις·
                // η ετήσια δεν χαρίζει μήνες, χρεώνει λιγότερους. Ο σύνδεσμος
                // λέει πόσους, δίπλα στο ποσό που γράφει η γραμμή από πάνω.
                ...
                inherits={prev ? `Όλα του «${prev.nameGen}» και:` : 'Περιλαμβάνει:'}
                planId={id}
                ai={aiLimitsFor(id).perMonth}
                aiDay={aiLimitsFor(id).perDay}
                items={plan.features}
        ...
        {/* ΤΡΕΙΣ ΣΥΝΤΟΜΕΣ ΓΡΑΜΜΕΣ, ΟΧΙ ΜΙΑ ΠΑΡΑΓΡΑΦΟΣ. Ήταν πέντε γραμμές στον
            υπολογιστή και δεκατρείς στο τηλέφωνο, με το σημαντικότερο (ότι τίποτα
            δεν χρεώνεται ακόμη) θαμμένο στη μέση. Εκείνο πήγε πάνω από τις τιμές·
            εδώ μένουν η δοκιμή με το όριό της, ο ΦΠΑ και η εγγύηση. */}
        <p className="fineprint" style={{ fontSize: 13, lineHeight: 1.6, color: FAINT, margin: '22px 0 0' }}>
          <span style={{ display: 'block' }}>{TRIAL_OFFER}{billingLive && <> {billingWords().firstCharge}</>}</span>
          <span style={{ display: 'block' }}>Οι τιμές αφορούν καταναλωτές στην Ελλάδα και περιλαμβάνουν ΦΠΑ. Χωρίς δέσμευση ή ποινή αποχώρησης.</span>
          <span style={{ display: 'block' }}>{billingWords().moneyBack}</span>
        </p>
        {/* Η ΣΕΛΙΔΑ ΤΩΝ ΠΑΚΕΤΩΝ ΔΕΝ ΕΙΧΕ ΚΑΜΙΑ ΕΙΣΟΔΟ ΑΠΟ ΤΗΝ ΑΡΙΘΜΗΤΙΚΗ ΤΟΥΣ.
            Οι κάρτες δείχνουν πέντε γραμμές η καθεμιά· ο πίνακας γραμμή προς
            γραμμή ζούσε στο /paketa και τον έβρισκε μόνο ο συνδρομητής. */}
        <div style={{ marginTop: 10 }}>
          <Link href="/paketa" className="lp-link po-tap" style={{ color: ACCENT, textDecoration: 'none', fontSize: 14, fontWeight: 600 }}>
            Δες αναλυτικά τι περιλαμβάνει κάθε πακέτο
          </Link>
        </div>
      </section>
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        ...
        <p className="fineprint" style={{ fontSize: 13, color: FAINT, margin: '22px 0 0' }}>
          ...
          {/* Γενική πτώση από το `nameGen`: «έναν μήνα Επαγγελματία», όχι
              «έναν μήνα Επαγγελματίας». Και μία πρόταση με «και», όχι τρεις
              προτάσεις κολλημένες με κόμματα.

              ΤΟ ΣΧΟΛΙΟ ΖΕΙ ΠΑΝΩ ΑΠΟ ΤΟ ΚΕΙΜΕΝΟ, ΟΧΙ ΑΝΑΜΕΣΑ. Ανάμεσα σε δύο
              σειρές κειμένου το JSX σβήνει την αλλαγή γραμμής γύρω από την
              έκφραση· η σελίδα έγραφε «έγγραφο.Ο Συνεργάτης», κολλητά.
...
function PlanCard({ planId, name, nameColor, sub, price, per, note, annual, inherits, ai, aiDay, items, cta, ctaGhost, featured }: {
