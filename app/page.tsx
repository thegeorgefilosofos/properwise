...
export default async function Landing() {
  ...
  return (
    <div className="lp-root min-h-dvh" data-mode="dark" style={{ color: TEXT, fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      {/* ΜΟΝΟ ΟΤΑΝ ΥΠΑΡΧΕΙ ΤΙ ΝΑ ΑΝΤΑΜΕΙΨΕΙ. Και οι δύο ανταμοιβές μετρούν
          συνδρομές· με το ταμείο κλειστό η ενότητα υποσχόταν κάτι που δεν
          πιάνεται και έκανε πιο μακριά μια σελίδα που ήταν ήδη η μακρύτερη
