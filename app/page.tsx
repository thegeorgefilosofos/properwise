...
import { TRIAL_PLAN, FEATURE_MIN_PLAN } from '@/lib/billing/entitlements';
...
const FAQ = [
  ...
  { q: 'Πόσες ερωτήσεις μπορώ να κάνω στον βοηθό;', a: `Ο βοηθός περιλαμβάνεται σε κάθε πακέτο και αλλάζει μόνο το πλήθος των ερωτήσεων, από ${aiLimitsFor('solo').perMonth} τον μήνα στον ${PLANS.solo.name} ως ${aiLimitsFor('office').perMonth} στον ${PLANS.office.name}. Το πακέτο ανανεώνεται την 1η κάθε μήνα.` },
  ...
  { q: 'Δουλεύει στο κινητό;', a: 'Ναι. Προσαρμόζεται σε κινητό, tablet και υπολογιστή και η σάρωση αποδίδει καλύτερα με την κάμερα του κινητού ή του tablet. Εγκαθίσταται και στην αρχική οθόνη σαν εφαρμογή. Εφαρμογή για iOS και Android ετοιμάζεται· γράφεσαι στη λίστα αναμονής από τον λογαριασμό σου.' },
...
const STATS = [
  { n: '7',  u: 'είδη εγγράφων',           l: 'Από λογαριασμούς και μισθωτήρια ώς κρατικά έγγραφα.' },
  { n: '11', u: 'πάροχοι ρεύματος',        l: 'Τα πραγματικά τιμολόγιά τους, με πρόσφατο έλεγχο.' },
  ...
  return (
    <div className="lp-root min-h-dvh" style={{ color: TEXT, fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <section className="lp-hero" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ ...wrap, position: 'relative', zIndex: 1, paddingTop: 'clamp(40px, 5.5vw, 68px)', paddingBottom: GAP, textAlign: 'center' }}>
          ...
          <p className="lp-rise-2" style={{ fontSize: 'clamp(15px, 1.75vw, 17.5px)', color: 'var(--text-secondary)', lineHeight: 1.6, maxWidth: '100%', margin: '0 auto 28px', textWrap: 'balance' }}>
            Ενοίκια, λογαριασμοί, δάνεια και φόροι, για κάθε ακίνητο. Ρωτάς στα
            ελληνικά και ο βοηθός απαντά με{' '}
      ...
      <section id="pricing" className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        <SectionHead over="Τιμολόγηση" title="Και τι κοστίζει το καθένα" sub="Κάθε πακέτο περιλαμβάνει ό,τι έχει το προηγούμενο. Οι τιμές περιλαμβάνουν ΦΠΑ." />
          ...
          {LANDING_PLANS.map((id, i) => {
            ...
            return (
              <PlanCard
                ...
                annual={`Ετήσια, πληρώνεις ${paidMonths} μήνες`}
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        ...
        <p className="fineprint" style={{ fontSize: 13, color: FAINT, margin: '22px 0 0' }}>
          ...
          {PLANS[partnerWelcomeTier('agency')].nameGen} (ανάλογα με το πακέτο του) και κρατά δωρεάν κάθε
