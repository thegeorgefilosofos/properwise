...
export async function proxy(request: NextRequest) {
  ...
  const PUBLIC = new Set([
    ...
    "/odigos/pos-ypologizetai-o-enfia", "/odigos/kathari-apodosi-akinitou",
    ...
    "/tameio",
    // Η ΣΥΝΤΟΜΗ ΔΙΕΥΘΥΝΣΗ ΤΗΣ ΕΠΑΛΗΘΕΥΣΗΣ. Το «/verify/<κωδικός>» ήταν ήδη
    // δημόσιο· το σκέτο «/verify», που πληκτρολογεί όποιος έχει μόνο το χαρτί,
    // έστελνε στη σύνδεση. Εκεί ζει πλέον η φόρμα του κωδικού.
    "/verify",
  ]);
