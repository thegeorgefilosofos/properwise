...
//
//   Ιδιοκτήτης     δωρεάν: τα φορολογικά ενός σπιτιού, Ε2, Δήλωση μίσθωσης, ΕΝΦΙΑ
//   … με Νόα       ο ίδιος, με τον ψηφιακό βοηθό και σάρωση χωρίς όριο
...
export const FEATURE_MIN_PLAN: Record<Feature, PlanId> = {
  // ΑΠΟ 25.09.2026 ΔΩΡΕΑΝ. Ο «Ιδιοκτήτης» χωρίς συνδρομή έχει όλα τα
  // φορολογικά του ενός σπιτιού· αυτό που πληρώνεται είναι η Νόα (aiLimits.ts).
  e2_export:          'free',
  rent_collection:    'free',
