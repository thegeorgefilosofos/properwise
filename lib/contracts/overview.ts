 ...
 * «Πρόσθεσε … και διαβάζονται …» — όχι άλλοτε ερώτηση, άλλοτε διαπίστωση.
 *
 * ΚΑΙ ΕΝΑ ΡΗΜΑ ΓΙΑ ΤΗΝ ΙΔΙΑ ΕΝΕΡΓΕΙΑ. Ήταν «Ανέβασε», «Φωτογράφισε»,
 * «Καταχώρησε» και «Κατέγραψε» για το ίδιο πάτημα, που ανοίγει τον ίδιο δρόμο.
 */
export const CONTRACT_EMPTY_HINT: Record<ContractKind, string> = {
  electricity: 'Πρόσθεσε έναν λογαριασμό ρεύματος και διαβάζονται πάροχος, τιμολόγιο, κατανάλωση και ρήτρες.',
  gas: 'Πρόσθεσε έναν λογαριασμό φυσικού αερίου, ή δήλωσε τον τρόπο θέρμανσης αν δεν έχεις σύνδεση.',
  water: 'Πρόσθεσε τον τελευταίο λογαριασμό νερού, που έρχεται συνήθως ανά δίμηνο και όχι ανά μήνα.',
  internet: 'Πρόσθεσε λογαριασμό σταθερού τηλεφώνου ή internet και διαβάζονται πάροχος, πάγιο και ταχύτητα.',
  insurance: 'Πρόσθεσε το ασφαλιστήριο και διαβάζονται εταιρεία, ασφάλιστρο, καλύψεις και ημερομηνία λήξης.',
  common: 'Πρόσθεσε την ειδοποίηση κοινοχρήστων που σου στέλνει ο διαχειριστής της πολυκατοικίας.',
  subscriptions: 'Πρόσθεσε τις συνδρομές και περνούν στις δαπάνες και στο ημερολόγιο, με το μερίδιο που πληρώνεις.',
  services: 'Πρόσθεσε τα δημοτικά τέλη και τις λοιπές δαπάνες του ακινήτου σου, όπως καθαρισμό και ασανσέρ.',
};
