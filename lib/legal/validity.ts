...
export const REGULATED: readonly Regulated[] = [
  ...
  // ξανακοιταχτεί. Ο ν.5222/2025 (άρθρο 210) του πρόσθεσε την προϋπόθεση της
  // τραπεζικής είσπραξης, με έναρξη κυρώσεων 1.7.2027 (Α.1187/2026).
  {
    ...
    recheck: 'Το ποσοστό 5% (άρθρο 39 ΚΦΕ) και η προϋπόθεση είσπραξης μέσω τραπέζης (ν.5222/2025 άρθρο 210 · κύρωση από 1.7.2027, Α.1187/2026): άλλαξε το ποσοστό, μετατέθηκε ξανά η έναρξη, ή προστέθηκαν αποδεκτοί τρόποι είσπραξης;',
  },
