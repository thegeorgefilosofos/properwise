...
// ═══ ΧΩΡΙΣ ΠΕΡΙΓΡΑΦΗ, Η ΧΡΕΩΣΗ ΠΑΙΡΝΕΙ ΟΝΟΜΑ ════════════════════════════
{
  const [c] = priceChanges(run(M, [81, 81, 81, 81, 57], { title: 'Χωρίς περιγραφή', category: 'water', vendor: null }), day('2026-08-20'))
  ok('όχι «Χωρίς περιγραφή» στην πρόταση', !!c && !/Χωρίς περιγραφή/.test(c.message))
  ok('η κατηγορία γίνεται όνομα', !!c && c.message.startsWith('Νερό:'))
}
