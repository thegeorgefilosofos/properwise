...
/**
 * Η εποχή ΜΕΣΑ σε πρόταση, με πεζά και φυσική σειρά. Το «εποχή Μεσαία» ήταν
 * ετικέτα κολλημένη σε κείμενο· η ετικέτα μένει για πίνακες και φύλλα.
 */
export const SEASON_PHRASE: Record<Season, string> = {
  peak: 'εποχή αιχμής', high: 'υψηλή εποχή', mid: 'μεσαία εποχή', low: 'χαμηλή εποχή',
};
