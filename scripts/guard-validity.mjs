...
const EXPLAINS_ONLY = {
  ...
  'lib/core/hyphenate.ts': 'συλλαβιστής· οι αριθμοί νόμων στα σχόλιά του είναι παραδείγματα τυπογραφίας (πού σπάει μια παραπομπή), όχι τιμές',
  'lib/ui/justifyPolish.ts': 'λειαντής στοίχισης· η παραπομπή στο σχόλιο είναι παράδειγμα τυπογραφίας, όχι τιμή νόμου',
