...
const RUNTIME = [
  ...
  // ── Η ΖΩΝΗ ΠΟΥ ΠΙΑΝΕΙ Η ΕΝΗΜΕΡΩΣΗ ΓΙΑ COOKIES ────────────────────────────
  // Δεν είναι απόχρωση και δεν μπορεί να είναι σταθερά: το ύψος του πλαισίου
  // αλλάζει με το πλάτος (66 στα 1440 · 89 στα 390 · 127 στα 360), γιατί το
  // κείμενο τυλίγει αλλιώς. Το μετρά και το δημοσιεύει το ίδιο το πλαίσιο
  // (app/CookieConsent.tsx) όσο είναι ορατό· γίνεται 0 όταν κλείσει.
  // Κάθε χρήση στο globals.css έχει εφεδρική τιμή 0px.
  { name: '--cookie-h', why: 'η ζώνη που πιάνει η ενημέρωση για cookies, μετρημένη· χωρίς αυτήν σκέπαζε το κουμπί της σύνδεσης' },
  ...
  { name: '--tbl-fs', why: 'μέγεθος κειμένου πίνακα, το δηλώνει η σελίδα για την .po-table' },
