...
const NOT_A_GUARD = {
  ...
  'perf:mobile': 'ΑΝΑΦΟΡΑ χρόνου σε προσομοιωμένο κινητό, ΟΧΙ φύλακας — κι αυτό είναι απόφαση, όχι παράλειψη. Ο χρόνος βγαίνει από πολλαπλασιαστή πάνω στον επεξεργαστή ΤΟΥ μηχανήματος που μετράει, άρα ο ίδιος κώδικας δίνει άλλο νούμερο σε άλλον δρομέα. Το ίδιο το scripts/lib/ratchet.mjs κρατά έξω τις μετρήσεις περιηγητή για τον ίδιο λόγο: φύλακας που κοκκινίζει από θόρυβο παρακάμπτεται μέσα σε έναν μήνα. Τρέχει κατ\' απαίτηση, πριν κι μετά από αλλαγή που αγγίζει βάρος ή απόδοση',
